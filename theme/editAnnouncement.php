...
<html>
  <head>
    ...
    />
    <link
      href="https://cdn.jsdelivr.net/npm/bulma-social@2.1.0/css/all.min.css"
      rel="stylesheet"
    />
    ...
    <link
      href="https://cdn.jsdelivr.net/npm/bulma-calendar@6.1.18/dist/css/bulma-calendar.min.css"
      rel="stylesheet"
    />
  </head>
  ...
  <body>
    ...
    <section class="container mb-6">
      <div class="columns is-multiline">
        <div class="column is-8 is-offset-2 register mb-6">
          <div class="columns">
            <div class="column left">
              <h1 class="my-4">Edit Announcement</h1>
            ...
            <div class="column right has-text-centered">
              <form action="editAnnouncement.php" method="POST">
                ...
                <button
                  class="btn is-block is-medium btn-main submitButton mb-2"
                  type="submit"
                >
                  Submit
                </button>
