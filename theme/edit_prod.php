...
function displayProductVariations($product) 
{
  ...
  foreach($items as $item) 
  {
    ...
    echo "
        <a href=\"edit_item.php?id=$item_id\" class=\"btn btn-solid-border\">$item_variation</a>
    ";
  }
}
        ...
        <div class="formbold-form-wrapper">    
          <!-- <form action="https://formbold.com/s/FORM_ID" method="POST"> -->
            ...
            <div class="formbold-mb-3">
              ...
              <input type="text" name="productName" id="productName" class="formbold-form-input" value="<?php echo $product_name; ?>"/>
            </div>
      
            <div class="formbold-mb-3"> 
              <label for="productDescription" class="formbold-form-label">Product Description</label>
              <textarea  class="formbold-form-prod_desc" id="productDescription" name="productDescription" rows="10" cols="50"><?php echo $product_description; ?></textarea>
            </div>
            ...
            <div class="formbold-mb-3"> 
              ...
              ?>
              <a href="create_item.php?id=<?php echo $prospectid; ?>" class="btn btn-solid-border">Add Variant <i class="fa fa-plus"></i></a>
            </div>

            <div class="formbold-mb-3">
                <label for="productCategory" class="formbold-form-label">Category</label>
                <select name="productCategory" id="productCategory" class="formbold-form-input">
            ...
            <div class="formbold-mb-3" style="color: black;">
                ...
                <?php
                    ...
                    {
                        echo "
                            <input type=\"checkbox\" name=\"catCheckbox\" checked> Cats
                            <input type=\"checkbox\" name=\"dogCheckbox\" checked> Dogs
                        ";
                    }
