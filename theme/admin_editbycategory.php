...
class Item
{
  ...
  function __construct($itemId, $itemVariation, $itemImage, $itemPrice, $itemStocks, $itemVisibility) 
  {
    $this->itemId = $itemId;
...
function displayProduct($product, $all, $forNavigation)
{
  ...
  if($all) 
  {
    ...
    {
        echo "
        <div style=\"background-color:#D3D3D3\" class=\"product-image-wrapper\">";
    } else
        echo "
...
function getItems($con, $product_id)
{
  ...
  if ($numrows != "" && $numrows != 0) 
  {
      for ($i = 1; $i <= $numrows; $i++)
      {
        ...
        $item = new Item($id, $variation, $image, $price, $stocks, $is_visible);
        ...
        <div class="row">
              ...
              <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a href="admin_shop.php">All Products</a>
                    </h4>
                    <br/>
                    <h4 class="panel-title">
                  ...
                  <div id="sportswear" class="panel-collapse collapse in">
                    <div class="panel-body">
                      <ul>
                        <li><a href="admin_editbycategory.php?category_id=1&intendedFor=C">Cat Food and Treats</a></li>
                        <li><a href="admin_editbycategory.php?category_id=5&intendedFor=C">Cat Vitamins</a></li>
                        <li><a href="admin_editbycategory.php?category_id=2&intendedFor=C">Cat Medications and Others</a></li>
                        <li><a href="admin_editbycategory.php?category_id=3&intendedFor=C">Cat Shampoo and Soap</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
                <div class="panel panel-default">
                  ...
                  <div id="mens" class="panel-collapse collapse in">
                    <div class="panel-body">
                      <ul>
                        <li><a href="admin_editbycategory.php?category_id=1&intendedFor=D">Dog Food and Treats</a></li>
                        <li><a href="admin_editbycategory.php?category_id=5&intendedFor=D">Dog Vitamins</a></li>
                        <li><a href="admin_editbycategory.php?category_id=2&intendedFor=D">Dog Medications and Others</a></li>
                        <li><a href="admin_editbycategory.php?category_id=3&intendedFor=D">Dog Shampoo and Soap</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-sm-9 padding-right">
            <div class="features_items"><!--features_items-->
              ...
              <a href="create_prod.php"> <button style=" position: absolute; right: 10px; top: 10px;"type="submit">Add Product</button> </a>
              </br>
              </br>
              </br>
              <!-- DISPLAYING PRODUCTS -->
